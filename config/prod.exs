...
config :serialized_adventures, SerializedAdventuresWeb.Endpoint,
  ...
  url: [scheme: "https", host: "serialized-adventures.herokuapp.com/", port: 443],
...
# start per endpoint:
#
#     config :serialized_adventures, SerializedAdventuresWeb.Endpoint, server: true
#
